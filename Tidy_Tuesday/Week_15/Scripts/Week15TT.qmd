...
# Set path to data (assumes file is downloaded locally as per instructions)
# If not available locally, it will read from the URL.
...
# Wrangle data
# We want to highlight years where the summer was a "Record" (>19°C)
# and see if they correspond to short burn durations.
...
color_hot <- "#FF4500"   # OrangeRed
color_norm <- "#4682B4"  # SteelBlue
